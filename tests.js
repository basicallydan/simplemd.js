...
function assertOutputEqual(func, input, expectedOutput) {
	...
	try {
		output = func(input);
		console.assert(output === expectedOutput, 'Equality test', testNum, 'failed:');
	} catch (e) {
...
assertOutputEqual(parseMarkdown,
	'This is a paragraph\n\nThis is another paragraph.',
	'<p>This is a paragraph</p>\n<p>This is another paragraph.</p>');
assertOutputEqual(parseMarkdown, '# Header 1', '<h1>Header 1</h1>');
assertOutputEqual(parseMarkdown, '## Header 2', '<h2>Header 2</h2>');
assertOutputEqual(parseMarkdown,
	'#Header 1\n\nThis is a paragraph\n\nThis is another paragraph.',
	'<h1>Header 1</h1>\n<p>This is a paragraph</p>\n<p>This is another paragraph.</p>');
assertOutputEqual(parseMarkdown,
